...
internal struct FWP_VALUE0
{
	...
	public FWP_VALUE0_Union Union;

	public static implicit operator FWP_VALUE0(byte value)
	{
		return new FWP_VALUE0
		{
			type = FWP_DATA_TYPE.FWP_UINT8,
			Union = new FWP_VALUE0_Union
			{
				uint8 = value
			}
		};
	...
	public static implicit operator FWP_VALUE0(sbyte value)
	{
		return new FWP_VALUE0
		{
	...
	public static implicit operator FWP_VALUE0(int value)
	{
		return new FWP_VALUE0
		{
	...
	public static implicit operator FWP_VALUE0(uint value)
	{
		return new FWP_VALUE0
		{
	...
	public static implicit operator FWP_VALUE0(ushort value)
	{
		return new FWP_VALUE0
		{
